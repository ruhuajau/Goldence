    ...
    func loadBookshelves() {
        ...
        bookshelvesCollection.addSnapshotListener { (querySnapshot, error) in
            ...
            for document in querySnapshot!.documents {
                ...
                if let title = data["name"] as? String, let imageURL = data["imageURL"], let documentID = data["bookshelf_id"] as? String {
                    let bookshelf = Bookshelf(bookshelfID: documentID, title: title, imageURL: imageURL as? String)
